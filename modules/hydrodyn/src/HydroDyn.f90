...
!==========================================
      ...
      IF (InitLocal%HasSeaFEM .eqv. .TRUE.) THEN
         ...
         CALL SeaFEM_Init(InitLocal%SeaFEM, u%SeaFEM, p%SeaFEM, x%SeaFEM, xd%SeaFEM, z%SeaFEM, OtherState%SeaFEM, y%SeaFEM, m%SeaFEM, Interval, InitOut%SeaFEM, ErrStat2, ErrMsg2 )
...
SUBROUTINE HydroDyn_CalcOutput( Time, u, p, x, xd, z, OtherState, y, m, ErrStat, ErrMsg )   
      ...
      TYPE(HydroDyn_OtherStateType),      INTENT(INOUT)  :: OtherState  !< Other states at Time
...
#ifdef SeaFEM_active
      TYPE(SeaFEM_ConstraintStateType)     :: SeaFEM_z        ! Initial guess of the constraint states
      REAL :: forces(3),Momentum(3)
#endif
...
!..................................................................................................................................
   ...
   TYPE(HydroDyn_OtherStateType),              INTENT(INOUT)           :: OtherState !< Other states at operating point
